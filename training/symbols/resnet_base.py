...
def residual_unit(data, num_filter, stride, dim_match, name, height=1, bottle_neck=True, bn_mom=0.9, workspace=256, memonger=False):
...
def resnet(input_name, units, filter_list, num_classes, height=1, bottle_neck=True, bn_mom=0.9, workspace=256, memonger=False):
